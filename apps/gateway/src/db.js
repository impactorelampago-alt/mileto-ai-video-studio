...
CREATE TABLE IF NOT EXISTS media_items (
    ...
    visibility   TEXT NOT NULL DEFAULT 'library' CHECK (visibility IN ('library', 'project', 'backup')),
...
ALTER TABLE media_items ADD CONSTRAINT media_items_visibility_check CHECK (visibility IN ('library', 'project', 'backup'));
...
-- Cofre pessoal: IDs de projetos podem coincidir com rascunhos publicados e
-- com os de outras pessoas da mesma organização sem expor o conteúdo.
...
ALTER TABLE private_backup_projects ADD COLUMN IF NOT EXISTS version BIGINT NOT NULL DEFAULT 1;
...
ALTER TABLE private_backup_files ADD COLUMN IF NOT EXISTS version BIGINT NOT NULL DEFAULT 1;
...
CREATE INDEX IF NOT EXISTS idx_private_backup_project_assets_item ON private_backup_project_assets(asset_item_id);
...
DROP TABLE IF EXISTS ai_generation_jobs, ops_audit_events, external_media_references, ops_sync_conflicts, ops_sync_runs,
    ...
    private_backup_project_assets, private_backup_files, private_backup_projects,
