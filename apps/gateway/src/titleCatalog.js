export const TITLE_MODEL_IDS = [
    'premium-kinetic-punch', 'premium-sticker-pop', 'premium-marker-swipe', 'premium-split-block',
    'premium-outline-echo', 'premium-creator-caption', 'premium-sale-spotlight', 'premium-price-tag',
...
export const TITLE_ANIMATION_IDS = ['pop', 'fade', 'slide', 'blink', 'none'];
export const TITLE_ANIMATION_ID_SET = new Set(TITLE_ANIMATION_IDS);
