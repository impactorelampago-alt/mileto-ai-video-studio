...
const renderContext = (voices) => [
    ...
    'Quando o usuário descrever um estilo vocal e houver correspondência clara com o nome ou a descrição de uma voz listada, você pode oferecer no máximo uma sugestão breve e opcional, citando apenas o nome da voz e a razão editorial da adequação.',
    'A sugestão nunca deve interromper, bloquear ou adiar a criação solicitada. Não exija confirmação, não transforme a conversa em formulário e não force uma escolha.',
    'Se uma voz estiver marcada como selecionada, respeite essa escolha e não proponha substituí-la espontaneamente. Só compare ou sugira troca quando o usuário pedir isso explicitamente.',
