...
router.post('/files/folder/move', fileExplorerController.moveFolder);
router.post('/files/folder/copy', fileExplorerController.copyFolder);
router.delete('/files/folder', fileExplorerController.deleteFolder);
...
router.post('/shared/files/item/:assetId/materialize-audio', sharedController.materializeAudio);
